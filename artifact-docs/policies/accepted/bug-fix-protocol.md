...
**Why:** TLO-43 (6 runs) and TLO-36 (4 runs) both involved complex state bugs where code-reading led to incomplete fixes. Reproduction forces the correct failure mode to be visible before the fix is written.
